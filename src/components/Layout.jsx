                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex space-x-2 items-center">
                            {isAdmin ? (
                                <Link to="/upload" className="px-3 py-2 rounded-lg text-sm font-semibold bg-blue-600 text-white hover:bg-blue-500 transition shadow-lg shadow-blue-900/20 flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="px-3 py-2 rounded-lg text-sm font-semibold bg-white/10 hover:bg-white/20 text-gray-200 transition flex items-center gap-2"
                                >
                                    {!currentUser && (
